...
export function Header() {
  ...
  return (
    <header className="h-16 border-b border-gray-100 bg-white/80 backdrop-blur-md flex items-center justify-between px-6 z-20 sticky top-0">
      <div className="flex items-center gap-4">
        <button onClick={toggleSidebar} className="p-2 rounded-lg hover:bg-gray-50 transition-colors lg:hidden">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-72 pl-9 pr-4 py-2 text-sm bg-gray-50 rounded-xl border border-transparent focus:bg-white focus:border-indigo-300 focus:outline-none transition-all"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {/* AI Assistant */}
        <button onClick={() => navigate('/profile')} className="relative p-2 rounded-xl hover:bg-gray-50 transition-colors group">
        ...
        {/* Notifications */}
        <button onClick={() => toast('暂无新通知', 'info')} className="relative p-2 rounded-xl hover:bg-gray-50 transition-colors">
